...
| D02 | 인지·상태를 구분하는 장편 기억 확장 | 근거·적용 시점·승인/stale, 미래 복선 구분, 복선의 audience_knows, **아크 요약 슬라이스(2026-09-14)** — `summary_jobs.kind='arc'`·`arc_summary` MemoryEntry·`arc-v1`(migration `d1e2f3a4b5c6`) [설계](../specs/2026-09-14-hierarchical-memory-500ep.md) | 잔여: 권 기억(volume_memory)·500화 커버리지 선택·작가/독자/인물별 인지와 사건/관계 영향 추적 도메인 설계 |
